<div class="w-1/2 my-10">
    ...
    {{-- <div wire:loading wire:target='photo'>Uploadind...</div>
    ...
    <div
        ...
        style="background-image: linear-gradient( 89.9deg,  rgba(208,246,255,1) 0.1%, rgba(255,237,237,1) 47.9%,
         rgba(255,255,231,1) 100.2% );"
        @click="$refs.fileInput.click()">Upload Images</div>

        <!-- File Input -->
        <input x-ref='fileInput' type="file" wire:model="photos" multiple hidden>
